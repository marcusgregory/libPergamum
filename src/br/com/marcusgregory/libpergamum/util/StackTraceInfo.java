...
public class StackTraceInfo {
    ...
    public static String getInvokingClassSimpleName() {
        String invokingClassName = getInvokingClassName(2);
        invokingClassName = invokingClassName.substring(invokingClassName.lastIndexOf(".") + 1, invokingClassName.length());
